...
if st.session_state.page == "home":
    ...
    # === NEW: Download All Requests as Excel ===
    # Prepare a DataFrame for every stored request, flattening list‐fields into comma‐separated strings:
